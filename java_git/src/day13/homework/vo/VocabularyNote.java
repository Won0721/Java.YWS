...
public class VocabularyNote {
	...
	/**단어가 주어지면 단어장에서 삭제하고 삭제여부를 알려주는 메서드
...
//			System.out.println("Wrong number");
	...
	/**단어와 수정할 단어가 단어가 주어지면 단어를 변경하고변여부를 알려주는 메서드
	 ...
	 * 메서드명 : deleteMeaning
	 */
	public boolean deleteMeaing(String title, int num) {
		// 단어 위치를 찾음
		int index = indexOf(title);
		// 단어가 없으면 삭제 못함
		if(index ==-1) {
