...
import day09.classEx2.B;

/*접근 제어자
 : 클래스의 멤버변수, 메서드, 생성자에 대한 접근을 지정하는 예악어

	private : 자신 클래스에서만 사용가능
	(default) : 자신 클래스 + 같은 패키지 // 생략되어있음 
	protected : 자신 + 같은패키지 + 자식
	public : 모두
 */
public class AccessModifierEx {
	public static void main(String[] args) {
		...
		// num 3은 접근제어자가 public
		// AccessModifier 클래스와 A클래스는 같은 패키지에 있는 클래스
		// AccessModifier 클래스와 B클래스는 다른 패키지에 있는 클래스
		// num3은 접근제어자가 public. 같은패키지이든 아니든 상관 없음
		a.num3 = 10;
		b.num3 = 20;
		
		// num2는 접근제어자가 default : 자신클래스 + 같은패키지
		/// 다른 패키지에 있는 B클래스의 객체에 있는 num2(멤버변수) 접근이 안됨
		a.num2 = 10;
		//b.num2 = 20;
...
class A{
	...
	// private으로 된 num1에 접근하기 위해 getter를 추가한다.
	public int getNum1() {
		return num1;
	}
